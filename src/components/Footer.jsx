    ...
    <footer className="w-full py-8 px-2 sm:px-4 md:px-6 bg-[#F6F0E8] font-sans">
      ...
      <div className="w-full max-w-[96%] xl:max-w-[1520px] mx-auto bg-[#211A19] text-white rounded-[2.5rem] p-8 md:p-12 lg:p-14 shadow-2xl relative overflow-hidden space-y-10 border border-white/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start relative z-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            >
              ...
              <span className="font-serif italic text-3xl sm:text-4xl font-bold text-white group-hover:text-[#C8A878] transition-colors leading-none tracking-tight">
                DigiLocal <span className="text-[#D6B7A5] font-sans text-xs uppercase tracking-widest block font-bold pt-1 not-italic">Network</span>
              </span>
            </div>
            ...
            <div className="space-y-1.5">
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white tracking-tight flex items-center gap-1.5 flex-wrap">
                Your <span className="text-[#D6B7A5] font-extrabold underline decoration-[#D6B7A5]/40 decoration-2">Society</span>. Your <span className="text-[#D6B7A5] font-extrabold underline decoration-[#D6B7A5]/40 decoration-2">Vendors</span>. Your <span className="text-[#D6B7A5] font-extrabold underline decoration-[#D6B7A5]/40 decoration-2">Doorstep</span>.
              </h3>
              <p className="text-xs sm:text-sm text-[#D6B7A5] leading-relaxed max-w-lg pt-1">
                Connecting residential communities with trusted local vendors through express hyperlocal ordering.
              </p>
            </div>
          ...
          {/* RIGHT LINKS COLUMNS */}
          <div className="lg:col-span-7 pt-8 lg:pt-0 border-t lg:border-t-0 lg:border-l border-white/10 lg:pl-10 grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-10">
            
            {/* Column 1: EXPLORE */}
            <div className="space-y-4">
              <div className="space-y-1">
                <h4 className="text-xs font-extrabold text-[#D6B7A5] uppercase tracking-widest font-sans flex items-center gap-1">
                  EXPLORE
                </h4>
              ...
              <ul className="space-y-3.5 text-xs sm:text-sm text-white">
                ...
                <li>
                  <button 
                    ...
                    className="hover:text-[#C8A878] transition-colors flex items-center space-x-2 text-left group"
                  >
                    <Store className="w-4 h-4 text-[#D6B7A5] group-hover:text-[#C8A878] shrink-0 group-hover:scale-110 transition-all" />
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <h4 className="text-xs font-extrabold text-[#D6B7A5] uppercase tracking-widest font-sans">
                  SUPPORT
                </h4>
                <div className="w-6 h-0.5 bg-[#C8A878]" />
              </div>
              ...
              <ul className="space-y-3.5 text-xs sm:text-sm text-white">
                ...
                <li>
                  <a 
                    ...
                    className="hover:text-[#C8A878] transition-colors flex items-center space-x-2 text-left group cursor-pointer"
                  >
                    <Mail className="w-4 h-4 text-[#D6B7A5] group-hover:text-[#C8A878] shrink-0 group-hover:scale-110 transition-all" />
                ...
                <li>
                  <button 
                    ...
                    className="hover:text-[#C8A878] transition-colors flex items-center space-x-2 text-left group cursor-pointer"
                  >
                    <HelpCircle className="w-4 h-4 text-[#D6B7A5] group-hover:text-[#C8A878] shrink-0 group-hover:scale-110 transition-all" />
                    <span>Help & FAQs</span>
                  </button>
                </li>
              </ul>
              ...
              <ul className="space-y-3.5 text-xs sm:text-sm text-white">
                <li>
                  <button 
                    ...
                    className="hover:text-[#C8A878] transition-colors flex items-center space-x-2 text-left group"
                  >
                    <Info className="w-4 h-4 text-[#D6B7A5] group-hover:text-[#C8A878] shrink-0 group-hover:scale-110 transition-all" />
                    <span>About Us</span>
                  </button>
                </li>
                <li>
                ...
                <li>
                  <button 
                    ...
                    className="hover:text-[#C8A878] transition-colors flex items-center space-x-2 text-left group"
                  >
                    <ShieldCheck className="w-4 h-4 text-[#D6B7A5] group-hover:text-[#C8A878] shrink-0 group-hover:scale-110 transition-all" />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10 pt-1">
          ...
          <button
            onClick={scrollToTop}
            className="w-10 h-10 rounded-full border border-white/20 bg-[#211A19] text-white hover:bg-[#541D26] hover:border-[#541D26] transition-all flex items-center justify-center shadow-md shrink-0 cursor-pointer"
            title="Scroll to Top"
          >
