...
class App {
  ...
  onCheck() {
    // Continuous smooth movement without snap locking
  }
  onResize() {
    if (!this.container) return;
    this.screen = {
      width: this.container.clientWidth || window.innerWidth || 1200,
  ...
  update() {
    ...
    // Continuous perpetual auto-rotation along the semi-circle arc
    if (!this.isDown) {
      this.scroll.target += 0.09;
    }
...
export default function CircularGallery({
  ...
  }, []); // Run ONLY ONCE on mount to ensure smooth 60fps WebGL rendering without blinking
